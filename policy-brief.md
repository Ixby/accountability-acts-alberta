...
The combined regime costs an estimated **$5 million per year at steady state**, achieved by year five. Year-one capital is approximately $1.7 million for the technology build (the ISC registry, the cross-reference engine, the identity-consistency platform, the Tier 0 automated audit system); year-one operating spending is approximately $1.5 million during partial-year operations. The drafter's allocation across offices: roughly 18 FTE at the Ethics Commissioner office, 6 FTE at the Auditor General office for the Enforcement Equity Report, 4 FTE at the Information and Privacy Commissioner for documentation standards and audit, plus shared technology operations. Per capita the regime sits modestly higher than peer Canadian provincial oversight regimes — a function of broader scope rather than higher unit costs.
