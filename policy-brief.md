...
In late 2022, during a national children's acetaminophen shortage, Premier Danielle Smith announced a deal to import children's acetaminophen from Turkey. The total cost, including the product, logistics, and administration, came in around $80 million. Health Canada eventually approved roughly $21 million worth of the supply for actual use. The rest sat in storage; some has since been redistributed.
...
The Public Interest Disclosure Act protects whistleblowers from retaliation. The federal regime — the *Public Servants Disclosure Protection Act* — has, since coming into force in 2007, produced only a handful of founded reprisal findings and a single-digit number of Tribunal decisions on the merits. The precise figure depends on whether "completed" means a Commissioner founded-finding, a Public Servants Disclosure Protection Tribunal hearing, or a remedy ordered. The published record sits in the Public Sector Integrity Commissioner's annual reports.
...
| Whistleblower burden of proof | on the whistleblower | on the whistleblower | on the whistleblower | on the whistleblower, with limited reverse onus under PSDPA s.2.1 once a complaint is accepted | on the employer once nexus shown, throughout |
| ISC disclosure for procurement | none | partial (Land Owner Transparency Act, real-property only) | none | partial federal contract registry | required above threshold, with Registrar hash check |
...
**PSDPA.** *Public Servants Disclosure Protection Act*, the federal whistleblower statute (in force since 2007). Cited in this brief because the published record from the Public Sector Integrity Commissioner shows only a handful of founded reprisal findings and a single-digit number of Tribunal decisions on the merits across its nearly two decades of operation, illustrating how a regime designed for the right purpose can underperform in practice.
