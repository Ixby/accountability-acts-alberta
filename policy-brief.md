...
The defence is bounded against abuse by five explicit limits. The advice has to have been obtained *before* the decision, not after the fact (§26(4A)) — retroactive opinion-creation does not qualify. The respondent has to disclose the facts they gave to counsel, not just the opinion they got back (§26(4B)) — withholding material facts from your own advisor voids the defence. Independent external counsel weighs more heavily than in-house government legal services (§26(4C)) — recognizing that lawyers advising the very office whose conduct is in question have an institutional conflict. The defence is unavailable where the conduct conferred a discretionary benefit on the official's own family, business associate, beneficial-ownership-related party, recent contributor above threshold, or entity in which the official held a beneficial interest, unless the Commissioner pre-cleared the conduct in writing before the decision (§26(4D)) — direct conflicts cannot be papered over by counsel's letter. And reliance on advice is not available at all for conduct that a reasonable person without legal training would recognize as a serious breach of public trust — awarding a benefit to oneself, conferring a benefit on someone with whom the official had an active personal or business relationship at the time of the decision, or exercising a discretionary power in exchange for a thing of value (§26(4E)). Counsel's permissive opinion on obvious corruption is evidence of opinion-shopping, not reasonable reliance.
