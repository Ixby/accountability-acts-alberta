...
In December 2022, Alberta Health Services launched a privatized community lab service under a long-term contract with DynaLIFE Medical Labs. The company was insolvent within months. AHS took the operation back in August 2023. In November 2025, the provincial Auditor General published *An Examination of Community Laboratory Services (Contract with DynaLIFE)* and estimated the DynaLIFE-specific taxpayer cost at approximately $109 million: roughly $32 million for the buyback inclusive of liabilities, plus roughly $77 million in sunk costs from the failed procurement.[^ag-dynalife] The AG's broader figure for all unsuccessful provincial lab procurements over the same period is approximately $125 million.
...
The Tylenol procurement is not a closed historical event. Subsequent Auditor General and provincial procurement reviews across 2024 and 2025 have continued to surface structural-failure patterns in adjacent procurements through the same delivery agency — sole-source decisions without contemporaneous reasoning, post-decision reconstruction, value transfers through arrangements that did not pass through standard procurement disclosure. The structural failure the Tylenol case names — emergency authority exercised without written contemporaneous reasons — is recurring, not historical. The bill's duty to document under Bill 1 §14A and the procurement-disclosure architecture under §15 are aimed at exactly this loop.
...
The Lobbyists Act asks: who is being paid to influence government, and on whose behalf? In Alberta, in-house lobbyists must register if their lobbying activities total at least 50 hours per year — about an hour a week, easy to sit just below. Consultant lobbyists register from the first communication. The 50-hour threshold has produced a working answer for some in-house arrangements: stay below it. The arrangement is not illegal. It uses the rule as written.
...
The defence is bounded against abuse by five explicit limits. **(4A)** the advice has to predate the decision, not be reconstructed afterward; **(4B)** the facts disclosed to counsel have to be the operative facts, not a sanitized version; **(4C)** independent external counsel weighs more heavily than in-house government legal services; **(4D)** the defence is unavailable where the conduct benefits the official's family, business associate, beneficial-ownership-related party, recent contributor above threshold, or interested entity, unless the Commissioner pre-cleared the conduct in writing before the decision; **(4E)** reliance on advice is not available at all for conduct that a reasonable person without legal training would recognize as a serious breach of public trust. Counsel's permissive opinion on obvious corruption is evidence of opinion-shopping, not reasonable reliance.

How the limits operate in practice. The case below is composite — invented Minister, invented contract, invented vendor — but the patterns it walks through (hospitality below the formal threshold, sub-threshold contributions, urgency engineered by the official's own prior decisions, late-arriving supportive opinions) appear in current Alberta procurement reviews. The composite is the cleanest way to walk the limits without mistaking a particular case for the analytical point. The Minister of Service Alberta signs off on a sole-source contract worth $14.2 million for cloud-migration consulting. The vendor is a mid-sized Calgary firm whose managing partner attended the Minister's wedding two years earlier and contributed $4,200 to the Minister's constituency association across the most recent reporting cycle, just under the threshold that would trigger §26(4D) automatically. The Minister's chief of staff flags procurement risk three days before signing. The Minister asks the department's senior solicitor for a written opinion. The opinion comes back the morning of the signing: sole-source is defensible on the urgency ground because the legacy system's vendor support contract expires in eleven weeks. The Minister signs. Six months later the Commissioner opens a file. The opinion is produced. So is a second opinion, dated four days after the signing, from outside counsel at a national firm, reaching the same conclusion. The Minister discloses both. What the Minister does not disclose, and what the file later turns up, is that the urgency was created by the Minister's own decision the previous quarter not to renew the legacy support contract on its standard renewal terms.

Run the case through the limits. §26(4A) is cleared on the in-house opinion, which predates the decision; the outside opinion fails it, having been obtained four days late. §26(4B) fails: the Minister did not disclose to the senior solicitor that the urgency the opinion turned on was a condition the Minister had personally engineered the previous quarter. Withholding the operative fact from counsel voids the defence on that opinion. §26(4C) compounds the problem: the only timely opinion is in-house, which weighs less than independent external counsel; the outside opinion that would have carried more weight is the one that arrived too late. §26(4D) is a closer call. The personal relationship is real but not within the enumerated categories; the contribution is below threshold; no §11C pre-clearance was sought, but on the facts as stated none was required. The limit does not strike the defence. §26(4E) is the limit that does. A Minister awarding a $14.2 million sole-source contract to a personal friend, on urgency the Minister manufactured, is conduct a reasonable person without legal training would recognize as a breach of public trust. Counsel's permissive opinion on those facts is evidence of opinion-shopping, not reasonable reliance.

On §26(2A), the engineered-urgency point is genuinely equivocal in isolation: a Minister can decline to renew a contract for legitimate reasons and later face genuine timing pressure from that decision. In the absence of §26(4E), evidentiary equipoise on that single element would resolve to the respondent. Because §26(4E) is engaged on the totality of the facts, the close-case tie-breaker is unavailable, and the determination rests on the Commissioner's preponderance finding.

How the defence operates in close cases: where the Commissioner has not established bad faith on a preponderance of the evidence, the determination goes to the respondent (§26(2A)). The defence is both a substantive shield where its conditions are met and a tie-breaker in evidentiary equipoise. Bad faith has to be affirmatively established. Doubt does not establish it. That asymmetry is the design choice — better that an occasional close case favours the official acting in good faith than that the regime terrorises the public service into paralysis. The asymmetry is bounded by the obvious-corruption limit, which removes the close-case benefit from cases where there is no real doubt about what the conduct was.
...
| Commissioner appointment | majority vote in Assembly | majority vote in Assembly | OIC on Assembly address (custom: all-party agreement) | Order in Council plus Commons resolution | two-thirds Committee plus two-thirds Assembly |
...
The bill replaces this. Appointment requires two-thirds in the Standing Committee on Legislative Offices and two-thirds in the full Assembly — a supermajority that almost always requires the support of more than one party. The term is seven years, non-renewable, so the Commissioner cannot court favour for reappointment. Seven years is also longer than a typical Alberta majority government, which means the Commissioner usually outlasts the government that appointed them. Anyone who held elected office or a party executive position within the previous seven years is ineligible. Removal requires the same two-thirds standard. If the position sits vacant for 120 days — about four months — the Chief Justice of King's Bench fills it, so a government cannot indefinitely starve the office by simply refusing to nominate.
...
Where the contract is large enough, the awarding body cross-references the ISC return against the political contributions registry. If an ISC has personally made political contributions above a match threshold within the previous four years — about one electoral cycle, the window in which most contemporary influence relationships sit — or holds executive office in a registered party, the match is referred to the Commissioner. The Commissioner conducts an initial review within ten business days (about two weeks). Only if a potential substantive conflict is identified is the award stayed for a further twenty business days (another month) for full investigation. The Commissioner can clear, condition, or recommend setting aside.
...
The bill scales penalties to capacity. Natural-person penalties combine a base amount calibrated to annual compensation with an asset-based enhancement applied above a regulatory threshold, plus a minimum floor scaled to Alberta's minimum wage. The lowest-paid public servants are protected by the floor; the wealthiest are reached by the enhancement. Defenders of strict identical-dollar equality have a moral case; utilitarian and Rawlsian traditions both favour proportionality on the grounds that equal marginal deterrence and protection of the worst-off matter more than the appearance of arithmetic equality. The structure is contested; it is also defensible.
...
The full text is in Appendix B. The bill is shorter than Bill 1: a definitions Part, four substantive Parts covering the four channels through which advantage flows (named-party legislation; regulatory approvals; concessional arrangements; ministerial individual exemptions), an Enforcement Equity Reporting Part assigning the annual systemic review to the Auditor General, a common-provisions Part collecting the publication and correction architecture, and a closing Part for statutory review, severability, and commencement. Enforcement is delegated by reference to Bill 1: the Ethics Commissioner enforces breaches of disclosure obligations using the proceedings, defences, and audit mechanics of Bill 1's Parts 9 through 11.
...
The pattern this provision is aimed at — value moving from the Crown into private hands through arrangements that don't pass through procurement disclosure — has surfaced in current Alberta procurement and asset-management reviews. The Disclosure architecture would put each such arrangement on a register at the moment of execution, where comparison across arrangements becomes possible.
...
The pattern matters as much as the individual case. A Minister who has granted thirty individual exemptions in two years under a statute that contemplated rare exceptions is operating differently from a Minister who has granted three. Both might be defensible. Both should be visible. Recent Alberta procurement and emergency-procurement reviews have surfaced enough exercises of this authority to make the pattern question — how many, on what reasons, to whom — concrete rather than theoretical.
...
This is the hardest provision in the package to administer, and the most consequential. Right now, we don't even know enough to have the methodological argument. The brief should be honest about what *would* be required.

The methodology has four parts. First, a definition of "similarly-situated" that is robust enough to survive a skeptical regulator's response. The drafter's working position is that similarity has to be operationalized within sectors and conduct categories — same regulated activity (NAICS code or equivalent), same approximate scale (production volume, employee count, revenue band), comparable regulatory histories (priors, prior cooperation indicators), and overlapping geography where geography matters. Cross-sector comparisons are not what the report is for. Second, a comparator-pool methodology: for each enforcement decision the AG examines, the pool of similarly-situated parties facing comparable conduct over a comparable window has to be identifiable from the regulator's own records, and the AG has to be able to verify the pool independently. Third, a covariate model that holds known legitimate explanations (cooperation, severity, complexity, voluntary disclosure) statistically constant before testing whether residual variance correlates with the characteristics the report is built to surface (industry sector, size, political contribution history, recent state-benefit receipt). Fourth, a publication standard that distinguishes between "pattern identified" (a statistically credible asymmetry that warrants further inquiry) and "pattern not identified" (nothing the data can resolve), with neither characterization implying a corruption finding.

What the report cannot do at the design stage is replace regulator judgment in any individual case. The point is to identify patterns the regulator's own data reveals when assembled across cases — patterns the regulator may be unable to see because regulators see one file at a time. The methodology has to be developed in the open, with the Auditor General publishing a draft for comment in the first year of operation, and refined iteratively across the first reporting cycles. The five-year coverage timeline at Bill 2 §7 is calibrated to that iterative refinement, not to a fully formed methodology dropping in at year one.
...
The pattern across these failure modes is the same: every accountability regime in modern Canadian and British practice that has been substantially weakened was weakened by a confluence of three things — a captured appointment, a passive Assembly, and a slow erosion of resourcing. The bill's structural protections (supermajority appointment, two-thirds removal, eligibility bars on recent partisans, indexed thresholds, recorded-vote budget floors) raise the cost of each of those three independently. They do not eliminate the risk; they make it visible.

### Capture economics

A serious objection: by consolidating accountability machinery into three named offices — the Ethics Commissioner, the Auditor General, and the Information and Privacy Commissioner — the bills create a smaller, more legible target than today's diffuse landscape of accountability friction. A determined captor today has to neutralize many uncoordinated frictions: the press, parliamentary committees, the courts, FOIP applicants, civil society, procurement law, the existing officers of the legislature. The bills propose to consolidate substantial accountability work into three statutory offices whose appointment, term, removal, and budget are governed by named provisions. The supermajority threshold is the captor's checklist, not their wall.

The objection is real, and the brief should not let the supermajority do rhetorical work the analysis hasn't done. The honest framing is that the bills are a bet, with a cost on each side. Today's diffuse landscape is harder to capture in any single move, and partially captured already — newsroom contraction has thinned investigative coverage, parliamentary committees have been thinned by rotation and partisan capture, FOIP timelines have lengthened, civil-society organizations have been thinned by funding pressure. Diffuse friction has degraded faster than concentrated friction would. The bet is that three hardened offices, individually capturable but each requiring visible, multi-step capture in plain sight, raise the cost of subversion above the floor at which capture happens quietly today.

That bet is contestable. Whether three hardened offices are actually harder to capture than a federation of weakening uncoordinated frictions depends on the rate of decay in each, the rate at which a captor can move on each, and the visibility of each move. The brief takes the bet and names it. A reader who thinks the bet is wrong has a coherent position; the brief should not pretend otherwise. The structural protections (supermajority appointment, two-thirds removal, eligibility bars, randomness beacon, court confirmation, cooperation register, AG communications log, indexed budget floor) are the components of the bet. They survive or fail together.
...
These critiques are visible in the recent scholarship and in the briefs Indigenous governments have filed in comparable provincial legislative processes. The bill is structured to remain open to whatever co-development produces — the carve-out, the consultation requirement, and the §28(4) regulation-making authority can each absorb substantial revision without restructuring. Naming the critiques here is a starting point, not a substitute. The work itself is a precondition to tabling, and it has not been done.
...
In recognition that this material is structurally distinct from the procedural provisions that bind everyone else under the Act, §21A has been elevated to its own Part of Bill 1 — Part 8 — Indigenous Engagement at the Interface — with its own commencement gate under §32(3.1). The substantive engagement subsections cannot come into force until the Minister tables in the Assembly an engagement report describing the work done, with Treaty 6, Treaty 7, Treaty 8, the Métis Nation of Alberta, and the Métis Settlements General Council. The protective and definitional subsections come into force on Royal Assent so that the exemption for internal Indigenous governance is operative immediately.
...
What the drafter cannot do, and what Indigenous feedback alone can decide: whether the §21A line between exempt internal governance and covered contracting is drawn in the right place; whether the §21A(7) carve-out for Indigenous governance instruments is correctly drawn; whether the §21A(8) Council has the right composition, authorities, and procedure-of-constitution; whether the FPIC commitment is operationally workable as recalibrated; whether the §32 staging gives Indigenous governments enough time and the right framing; whether the bill should make space for Indigenous accountability traditions as parallel mechanisms or stay clear of them entirely; whether the audit, retention, and publication regime under §27, §29A, and §15(2A) honours Indigenous data sovereignty (OCAP — Ownership, Control, Access, and Possession of First Nations data); and the questions the drafter has not yet thought to ask. The bill is structured to absorb the answers. The drafter cannot supply them.
...
**Part I.** Office of the Auditor General of Alberta, *An Examination of Community Laboratory Services (Contract with DynaLIFE)* (November 19, 2025); reporting on the 2022 children's acetaminophen procurement in *The Globe and Mail* and CBC News (2023–2025); CBC News, "Incorporation of Alberta's energy war room means much of its operations remain secret" (October 4, 2019); other reporting on the Canadian Energy Centre in *The Globe and Mail*, CBC News, and *Edmonton Journal*, 2019–2024; Public Accounts of Alberta, fiscal years 2021–22 through 2024–25.
...
**Part IV.** Alberta *Lobbyists Act* registration data and Office of the Ethics Commissioner annual reports; National Institute of Standards and Technology, *Randomness Beacon Project* (csrc.nist.gov/projects/interoperable-randomness-beacons); *McIver v. Alberta (Ethics Commissioner)*, 2018 ABQB 240; *McIver v. Alberta (Ethics Commissioner)*, 2017 ABQB 695 (Speaker added as respondent on the procedural application).
...
I am Will Conner. I am not an expert in any single piece of what this brief touches — not law, not legislative drafting, not Indigenous governance, not constitutional doctrine, not public-sector finance. What I have is cross-domain exposure: enough of each, from enough angles, to assemble a starting point that someone with deeper expertise in any one area can argue with, revise, or replace.

The exposure: a fourth-year Bachelor of Computer Information Systems at Mount Royal University in Calgary, with coursework in business law, advanced business law, Indigenous leadership, systems thinking, and storytelling. Thirty years of professional information-technology work — I started fixing computers as a kid and have been paid for the work since age seventeen — across health care, social work, construction, and small business. Bylaw and policy drafting for non-profit organizations. Service on non-profit boards, including some I helped co-found. A few small businesses I have owned.
...
**PSDPA.** *Public Servants Disclosure Protection Act*, the federal whistleblower statute (in force since 2007). Cited in this brief because the Public Sector Integrity Commissioner has tabled 18 case reports and made 9 Tribunal referrals between 2007 and 2024, with merit decisions in the single digits, illustrating how a regime designed for the right purpose can underperform in practice. The Commissioner has proposed reverse-onus reform; that reform has not been enacted.
...
[^ag-dynalife]: Office of the Auditor General of Alberta, *An Examination of Community Laboratory Services (Contract with DynaLIFE)*, November 19, 2025. <https://www.oag.ab.ca/reports/an-examination-of-community-laboratory-services-contract-with-dynalife/>

[^myatt]: CBC News, "Incorporation of Alberta's energy war room means much of its operations remain secret," October 4, 2019. <https://www.cbc.ca/news/canada/edmonton/canadian-energy-centre-freedom-of-information-rules-exemption-1.5317360>

[^tylenol-disposition]: Reporting on the donation arrangement, including <https://www.cbc.ca/news/canada/calgary/alberta-turkish-tylenol-donation-1.7573150> and *The Globe and Mail* coverage of the procurement and its disposition, 2023–2025.
...
**(9) Anti-gaming.** The advance-ruling mechanism is bounded against strategic use as follows:

(a) **Aggregation.** Where the conduct contemplated is reasonably part of a course of related conduct, the Commissioner may require that all reasonably-related conduct be addressed in a single request. Artificial severance — submitting components of a related course of conduct as separate requests, each looking unproblematic in isolation — is grounds for declination of any of the severed requests.

(b) **Disclosure of related requests.** A requestor shall disclose, in each request, every other advance-ruling request the requestor or persons acting in concert with the requestor have filed on the same or related subject matter within the preceding 24 months, including any request that was withdrawn before decision.

(c) **Material divergence voids approval.** Where the conduct as carried out materially differs from the conduct as described in the request — in scope, parties, terms, timing, or any other respect a reasonable person would consider material to the Commissioner's analysis — the approval is void as to the divergent conduct, and proceedings may continue as if no advance ruling had issued.

(d) **Off-record contact prohibited.** A requestor and any person acting on the requestor's behalf shall conduct all communications about a pending request through the Commissioner's prescribed written channels. Off-record contact about a pending request — including contact through political or personal intermediaries — is conduct within the jurisdiction of the Commissioner under this Act and may, on its own, found a Public Report or Compliance Order regardless of the outcome of the request itself.

(e) **Time-bounded approvals.** An approval is valid for 12 months from the date of issue. Conduct not carried out within that period requires a fresh request unless the Commissioner extends the period in writing for stated reasons. Approvals do not function as standing cover for indefinite future conduct.

(f) **Ex post audit.** The Commissioner shall audit a random sample of approved requests, selected under the verifiable-randomness procedure in §27, to verify that conduct was carried out in accordance with the request and any conditions. Audit findings are aggregated in the quarterly compliance report under §23 and may identify individual non-compliance.

(g) **Annual pattern review.** The Commissioner shall publish annually, in the report under §24(3), an analysis of the year's advance-ruling activity covering: categories of requests, approval and declination ratios, average review times, conditions imposed, ex post audit results, and any patterns the Commissioner identifies as suggesting strategic use of the mechanism. Where patterns suggest a particular requestor, office, or class of conduct is using the mechanism strategically rather than for genuine certainty-seeking, the Commissioner shall identify the pattern and may recommend regulatory or legislative response.

(h) **Anti-bunching at decision deadlines.** A request received within 10 business days of a decision deadline the requestor faces in connection with the conduct is reviewable on an extended timeline at the Commissioner's discretion, and the Commissioner may decline to issue an approval where the time pressure prevents adequate review. Time-pressured requests do not defeat the Commissioner's ability to take longer where the matter warrants it.

**(10) Provisional reliance pending determination.** Where conduct that is the subject of a complete advance-ruling request must, by reason of timing the requestor cannot control, be carried out before the Commissioner issues a determination under subsection (2), the requestor may proceed in provisional reliance on the request, subject to the following:

(a) **Threshold for availability.** Provisional reliance is available only where:

(i) the request was filed at the earliest reasonable opportunity after the conduct was contemplated;

(ii) the request was complete on filing and disclosed every material fact in accordance with subsection (1);

(iii) the timing pressure arose from circumstances outside the requestor's control, and not from the requestor's own scheduling, deferral, or arrangement of decision deadlines connected with the conduct; and

(iv) the requestor filed contemporaneous written notice with the Commissioner, before carrying out the conduct, stating the date by which the conduct must be carried out, the reason awaiting the determination is not possible, and the specific external constraint that creates the timing.

(b) **Action at risk.** Conduct carried out in provisional reliance is conduct at the requestor's own risk. The complete defense under subsection (3) is available only if the Commissioner subsequently issues an approval under subsection (2)(a) on the same facts disclosed and the conduct as carried out conforms to that approval and any conditions.

(c) **Subsequent approval.** Where the Commissioner subsequently approves under subsection (2)(a) and the conduct as carried out conforms to the request and any conditions, the approval applies to the conduct already carried out as if the determination had been issued before the conduct. Conditions identified by the Commissioner as time-sensitive and incapable of retroactive application bind only future steps and shall be addressed by remediation under paragraph (d) or by future compliance, as the Commissioner directs.

(d) **Subsequent declination or non-conforming approval.** Where the Commissioner subsequently declines, or approves on conditions that the conduct as carried out cannot satisfy:

(i) the complete defense under subsection (3) is not available;

(ii) the good-faith defense under §26 remains available on its own terms, and the contemporaneous filing under paragraph (a)(iv) is admissible as evidence relevant to good faith;

(iii) the Commissioner may, in the same determination, identify remediation steps — including unwinding, restitution, divestiture, public correction, or modification of ongoing terms — that, if undertaken in good faith within a stated period, will bring the conduct into compliance and bar further proceedings under this Act on that conduct; and

(iv) where remediation is impossible, refused, or unsuccessful, proceedings under this Act may continue as if no advance ruling had issued.

(e) **Manufactured time pressure.** A finding under subsection (9)(h) that the requestor manufactured or aggravated the timing pressure is determinative against the availability of provisional reliance under this subsection. The contemporaneous filing under paragraph (a)(iv) is itself reviewable for accuracy, and a materially false statement in that filing is conduct within the jurisdiction of the Commissioner under this Act independent of the underlying request.

(f) **Preliminary view.** On receipt of notice under paragraph (a)(iv), the Commissioner may, within the time available before the conduct must be carried out, issue a preliminary view identifying any conditions the Commissioner would likely require or any aspect of the conduct the Commissioner would likely decline. A preliminary view is not a determination under subsection (2) and does not give rise to the defense under subsection (3), but a requestor's compliance with a preliminary view is admissible as evidence of good faith under §26 and counts toward remediation under paragraph (d)(iii).
...
**(1.1) Crown-internal reference, not characterization.** For greater certainty, subsection (1) is a Crown-internal reference applicable at the boundary between this Act and the governance systems of Indigenous peoples. Nothing in this Act is to be read as conferring, withholding, defining, or modifying recognition of Indigenous governance, which derives from sources independent of and prior to the Crown.
...
(c) the basis on which the regulation, as proposed, reflects the outcome of co-development; and

(d) any minority position recorded by an Indigenous governance body during the co-development process, which shall be reproduced in the report and tabled with the regulation.

The co-development report shall be tabled at least 60 sitting days before the regulation comes into force, and the regulation is subject to subsection (5) during that period.
...
**31A(1)** If any provision of this Act, or the application of any provision to any person or circumstance, is held by a court of competent jurisdiction to be invalid, unconstitutional, or otherwise unenforceable, the remainder of this Act, and the application of the provision to other persons or circumstances, remain in full force and effect.

**(2)** Where a provision is severed under subsection (1), the Commissioner shall, in the next quarterly compliance report under §23, identify the provision severed, the basis on which it was severed, and the operational consequences for the regime. The Minister shall introduce remedial legislation, or report in writing to the Legislative Assembly the reasons for not doing so, within 12 months of the determination.

**(3)** It is the legislative intent of this Act that each provision be capable of independent operation to the maximum extent consistent with its terms, and that severance preserve the protective effect of the remainder of the Act in respect of the public interest in transparent and accountable government.
