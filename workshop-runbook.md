...
- `bill-1-public-integrity-act.md`, `bill-2-open-books-act.md` — primary statutory text (Appendices A and B).
...
```bash
{
  ...
  echo ""; echo "---"; echo ""
  echo "# Appendix A — Bill 1: The Public Integrity Act of Alberta"
  echo ""; echo "*Full drafted text. Released under CC-BY-SA 4.0.*"
  echo ""; echo "---"; echo ""
  cat /c/Users/email/Documents/Claude/Projects/accountability-acts-alberta/bill-1-public-integrity-act.md
